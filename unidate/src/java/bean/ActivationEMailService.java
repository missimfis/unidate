 ...
 * SendActivationEMail that will manage the whole connection opening and
 * closing by itself.
 *
...
public final class ActivationEMailService {
	...
	/*	String messageText = FacesMessageHandler.getMessageByKey("reMindRegistrationEMailText", from, to, activationLink);
		String messageSubject = FacesMessageHandler.getMessageByKey("reMindRegistrationEMailSubject");
*/
