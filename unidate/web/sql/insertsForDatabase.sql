...
INSERT INTO `student`(`firstname`, `lastname`, `username`, `email`, `password`, `age`, `gender`, `interests`, `registrated`, `minage`, `maxage`, `completedProfile`, `about`, `department`, `studium`) 
VALUES ('Peter', 'Pan', 'asd','panpet@students.zhaw.ch', 'asd' , 24, 'men', 'women', true, 18, 30, true,'something interesting about me' ,'Technikum', 'Physio');
...
INSERT INTO `student`(`firstname`, `lastname`, `username`, `email`, `password`, `age`, `gender`, `interests`, `registrated`, `minage`, `maxage`, `completedProfile`, `about`, `department`, `studium`) 
VALUES ('Henna', 'Frau', 'test','test@students.zhaw.ch', 'testtest5' , 22, 'women', 'women', true, 18, 30, true,'something interesting about me' ,'Technikum', 'Physio');
